# 17-05-2020
# Fintan Ryan
# Scandinavian Daily New Cases (per million)
...
CSP <- SP + scale_color_manual(values=c('#002F6C','#FFCD00','#666666','#C7042d','#000000'))
CSP

# Removing Iceland, as it appears to be an outlier  when comparing countries
# by their per million figures, as they have a population of 360,000 people.
...
# Adding Color
CUSP <- USP + 
  scale_color_manual('Country', values = c('#002F6C','#FFCD00','#666666','#C7042d'))
CUSP
